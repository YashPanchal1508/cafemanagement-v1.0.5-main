...
export default function Sidebar1({ ...props }) {
  ...
  return (
    <Sidebar width="252px !important" className="h-screen top-0 bg-white-A700 shadow-sm !sticky overflow-auto">
      <Img src="public/images/Screenshot_2024-03-08_143414-removebg-preview.png" alt="image" className="h-[100px] w-[80%] mt-6 ml-7 mr-[97px]" />
      <Menu
        menuItemStyles={{
          button: {
        ...
        renderExpandIcon={() => (
          <Img
            src={isSubMenuOpen ? "/images/down-arrow-svgrepo-com(1).svg" : "/images/img_arrow_right.svg"}
            alt="arrow_icon"
