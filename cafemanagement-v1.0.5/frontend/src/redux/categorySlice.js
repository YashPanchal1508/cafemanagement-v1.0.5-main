...
export const categorySlice = createSlice({
    ...
    reducers: {
        ...
        editedCategorySlice: (state, action) => {
            const { data, pagination } = action.payload
            state.data = data
            state.pagination.finalTotal = pagination.totalCount;
            state.pagination.totalPages = pagination.totalPages;
...
export const { addCategorySlice, deleteCategorySlice, getCategorySlice, setCurrentPage, setRowsPerPage, editedCategorySlice,searchCategory } = categorySlice.actions;
